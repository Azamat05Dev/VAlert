...
from handlers.smart_exchange import (
    get_smart_exchange_conversation_handler,
    get_smart_exchange_handlers
)
...
def main() -> None:
    ...
    # Smart exchange
    application.add_handler(get_smart_exchange_conversation_handler())
